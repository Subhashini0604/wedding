...
const Header = () => {
  ...
  return (
    <Navbar className="border-b-2 dark:bg-black bg-gray-800 navbar">
      <Link
        to="/"
      ...
      <div className="flex gap-5 order-2 ml-auto">
        {currentuser ? (
          ...
          >
            <DropdownHeader>
              ...
              <span className="block text-sm">
                {" "}
                📧<strong>{currentuser.rest.email}</strong>
              </span>
            </DropdownHeader>
            ...
            <Link to="/Signin">
              <DropdownItem onClick={handleSignout}>
                {" "}
                ⬅️ <strong className="text-red-700">Sign out</strong>
              </DropdownItem>
            </Link>
          </Dropdown>
        ) : (
        ...
        <Button
          className="w-12 h-10  sm:inline btn"
          outline
          pill
      ...
      <NavbarCollapse>
        <div className="relative group ">
          <Navbar.Link active={path === "/PlanningTool"} as={"div"}>
            <Link to="/PlanningTool" className="text-white">
              PlanningTool
            </Link>
          </Navbar.Link>
        ...
        <div className="relative group">
          <Navbar.Link active={path === "/WeddingVendor"} as={"div"}>
            <Link to="/WeddingVendor" className="text-white">
              WeddingVendor
            </Link>
          </Navbar.Link>
          <div className=" md:absolute left-0 top-full hidden group-hover:flex flex-col mt-2 bg-white shadow-lg">
        ...
        <div className="relative group">
          <Navbar.Link active={path === "/WeddingVenue"} as={"div"}>
            <Link to="/WeddingVenue" className="text-white">
              WeddingVenue
            </Link>
          </Navbar.Link>
          <div className=" md:absolute left-0 top-full hidden group-hover:flex flex-col mt-2 bg-white shadow-lg">
        ...
        <div className="relative group">
          <Navbar.Link active={path === "/Bride"} as={"div"}>
            <Link to="/Bride" className="text-white">
              Bride
            </Link>
          </Navbar.Link>
          <div className=" md:absolute left-0 top-full hidden group-hover:flex flex-col mt-2 bg-white shadow-lg">
        ...
        <div className="relative group">
          <Navbar.Link active={path === "/Groom"} as={"div"}>
            <Link to="/Groom" className="text-white text-md ">
              Groom
            </Link>
          </Navbar.Link>
          <div className=" md:absolute left-0 top-full hidden group-hover:flex flex-col mt-2 bg-white shadow-lg">
